...
> 1. **Dê contexto** ao assistente apontando os arquivos do squad (especialmente `squads/vertice-os-artefatos-marvel/squad.yaml` e `squads/vertice-os-artefatos-marvel/workflows/order_lifecycle.yaml`).
> 2. **Peça que ele assuma a persona do orquestrador** (veja os agentes em `squads/vertice-os-artefatos-marvel/agents/`).
> 3. **Conduza o fluxo** respeitando os checkpoints humanos e validando cada handoff/contrato.
>
> **Prompt de ativação** (copie, cole e ajuste o briefing):
> ```text
> Assuma a persona do orquestrador do squad (veja os agentes em `squads/vertice-os-artefatos-marvel/agents/`)
> e conduza o fluxo definido em `squads/vertice-os-artefatos-marvel/`. Siga `squads/vertice-os-artefatos-marvel/workflows/order_lifecycle.yaml`.
...
> Leia @squads/vertice-os-artefatos-marvel/squad.yaml e assuma a persona do orquestrador do squad.
  Siga @squads/vertice-os-artefatos-marvel/workflows/order_lifecycle.yaml. Conduza o fluxo para o briefing: <...>
```
...
2. No **Chat / Composer (⌘/Ctrl + I)**, referencie os arquivos com `@`:
   ```text
   @squads/vertice-os-artefatos-marvel/squad.yaml @squads/vertice-os-artefatos-marvel/workflows/order_lifecycle.yaml
   Assuma a persona do orquestrador e conduza o fluxo para o briefing: <...>
   ```
3. **Persistente:** crie um `.cursorrules` na raiz apontando para `squads/vertice-os-artefatos-marvel/` como squad ativo.
...
```text
@workspace #file:squads/vertice-os-artefatos-marvel/squad.yaml #file:squads/vertice-os-artefatos-marvel/workflows/order_lifecycle.yaml
...
```text
Leia squads/vertice-os-artefatos-marvel/squad.yaml e assuma a persona do orquestrador.
Conduza o fluxo do squad e execute os scripts em squads/vertice-os-artefatos-marvel/scripts/ quando o passo pedir.
Briefing: <...>
```
...
- **Continue.dev:** use `@file` para `squads/vertice-os-artefatos-marvel/squad.yaml`; cole o prompt de ativação.
- **Aider:** `aider squads/vertice-os-artefatos-marvel/squad.yaml` e instrua o orquestrador.
- **ChatGPT / Gemini (sem acesso a arquivos):** copie o conteúdo de `squads/vertice-os-artefatos-marvel/squad.yaml` e `squads/vertice-os-artefatos-marvel/workflows/order_lifecycle.yaml` para o chat, cole o prompt de ativação e rode eventuais scripts localmente, colando a saída de volta.
