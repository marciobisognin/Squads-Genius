...
> 1. **Dê contexto** ao assistente apontando os arquivos do squad (especialmente `IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml`).
> 2. **Peça que ele assuma a persona do orquestrador** (veja os agentes em `IFFar-Squads/squads/integra-incubadora-ops-squad/agents/`).
> 3. **Conduza o fluxo** respeitando os checkpoints humanos e validando cada handoff/contrato.
>
> **Prompt de ativação** (copie, cole e ajuste o briefing):
> ```text
> Assuma a persona do orquestrador do squad (veja os agentes em `IFFar-Squads/squads/integra-incubadora-ops-squad/agents/`)
> e conduza o fluxo definido em `IFFar-Squads/squads/integra-incubadora-ops-squad/`.
...
> Leia @IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml e assuma a persona do orquestrador do squad.
...
2. No **Chat / Composer (⌘/Ctrl + I)**, referencie os arquivos com `@`:
   ```text
   @IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml
   Assuma a persona do orquestrador e conduza o fluxo para o briefing: <...>
   ```
3. **Persistente:** crie um `.cursorrules` na raiz apontando para `IFFar-Squads/squads/integra-incubadora-ops-squad/` como squad ativo.
...
```text
@workspace #file:IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml
...
```text
Leia IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml e assuma a persona do orquestrador.
Conduza o fluxo do squad e execute os scripts em IFFar-Squads/squads/integra-incubadora-ops-squad/scripts/ quando o passo pedir.
Briefing: <...>
```
...
- **Continue.dev:** use `@file` para `IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml`; cole o prompt de ativação.
- **Aider:** `aider IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml` e instrua o orquestrador.
- **ChatGPT / Gemini (sem acesso a arquivos):** copie o conteúdo de `IFFar-Squads/squads/integra-incubadora-ops-squad/squad.yaml` para o chat, cole o prompt de ativação e rode eventuais scripts localmente, colando a saída de volta.
