...
## Missão
Garantir a rastreabilidade: preservar textos, logs e calcular checksums de todos os artefatos para reprodutibilidade.

## Papel
Textos limpos, logs, checksums e trilha de auditoria.
...
## Entradas
- todos os artefatos da saída

## Saídas
- manifesto de checksums e trilha de auditoria
