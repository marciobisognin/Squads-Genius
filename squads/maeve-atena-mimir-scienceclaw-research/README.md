...
<p>
  ...
  <img src="https://img.shields.io/badge/domain-pesquisa%20cient%C3%ADfica-0984E3?style=for-the-badge" alt="domínio pesquisa científica" />
  <img src="https://img.shields.io/badge/license-MIT-6C5CE7?style=for-the-badge" alt="licença MIT" />
  <img src="https://img.shields.io/badge/language-pt--BR-FD79A8?style=for-the-badge" alt="pt-BR" />
</p>
...
```mermaid
flowchart TD
    A[Entrada: tema, problema ou corpus] --> B[Atena classifica a demanda]
    B --> C[Mimir planeja e conduz a busca]
    C --> D[Tyr verifica referências e citações]
    D --> E[Saga avalia qualidade metodológica]
    E --> F[Hugin sintetiza achados]
    F --> G[Freya prepara entrega de pesquisa]
    F --> H[Gaia estrutura artigo científico]
    H --> I[Calliope redige manuscrito]
    I --> J[Minerva revisa como pares]
    J --> K[Tyr Integrity audita afirmações]
    K --> L[Themis formata e fecha o pacote]
```
...
```mermaid
flowchart LR
    subgraph Pesquisa[Pesquisa científica]
        A[Atena] --> B[Mimir]
        B --> C[Tyr Citation]
        C --> D[Saga]
        D --> E[Hugin]
    ...
    subgraph Artigo[Artigo científico]
        G[Gaia] --> H[Calliope]
        H --> I[Minerva]
        I --> J[Tyr Integrity]
        J --> K[Themis]
    ...
    E --> G
    F --> L[Relatório acadêmico]
    K --> M[Manuscrito auditado]
```
