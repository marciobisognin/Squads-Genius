...
**Nome provisório do squad:** `premium-report-design-squad`<br/>
**Versão do BRD:** 1.0<br/>
**Status:** proposta para validação antes da criação do squad<br/>
...
2. **Camada analítica visual detalhada**<br/>
...
- **Envato Elements — Annual Report Graphic Templates**<br/>
...
- **Behance — Annual Report Projects**<br/>
...
**Função:** coordenar o squad inteiro.<br/>
**Responsabilidades:**
...
**Entradas:** briefing do usuário, relatório pré-preenchido, dados e referências.<br/>
...
**Função:** entender o material recebido.<br/>
**Responsabilidades:**
...
**Função:** buscar referências de design aplicáveis ao tipo de relatório.<br/>
**Responsabilidades:**
...
**Função:** transformar conteúdo bruto em narrativa executiva.<br/>
**Responsabilidades:**
...
**Função:** validar e estruturar dados.<br/>
**Responsabilidades:**
...
**Função:** definir cores conforme empresa, setor, tema e tom.<br/>
**Responsabilidades:**
...
**Função:** definir fontes e hierarquia de leitura.<br/>
**Responsabilidades:**
...
**Função:** criar sistema visual reutilizável.<br/>
**Responsabilidades:**
...
**Função:** converter texto e dados em peças visuais.<br/>
**Responsabilidades:**
...
**Função:** escolher gráficos corretos e produzir visualizações.<br/>
**Responsabilidades:**
...
**Função:** desenhar experiência navegável do relatório em HTML.<br/>
**Responsabilidades:**
...
**Função:** implementar o relatório como site.<br/>
**Responsabilidades:**
...
**Função:** transformar o HTML em PDF com qualidade de impressão.<br/>
**Responsabilidades:**
...
**Função:** auditar aparência e organização.<br/>
**Responsabilidades:**
...
**Função:** garantir fidelidade do conteúdo.<br/>
**Responsabilidades:**
...
**Função:** organizar arquivos finais.<br/>
**Responsabilidades:**
