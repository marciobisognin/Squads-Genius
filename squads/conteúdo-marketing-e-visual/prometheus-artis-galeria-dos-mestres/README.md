...
> 1. **Dê contexto** ao assistente apontando os arquivos do squad (especialmente `squads/prometheus-artis-galeria-dos-mestres/squad.yaml` e `squads/prometheus-artis-galeria-dos-mestres/workflows/gerar-prompt-obra.yaml`).
> 2. **Peça que ele assuma a persona do orquestrador** (veja os agentes em `squads/prometheus-artis-galeria-dos-mestres/agents/`).
> 3. **Conduza o fluxo** respeitando os checkpoints humanos e validando cada handoff/contrato.
>
> **Prompt de ativação** (copie, cole e ajuste o briefing):
> ```text
> Assuma a persona do orquestrador do squad (veja os agentes em `squads/prometheus-artis-galeria-dos-mestres/agents/`)
> e conduza o fluxo definido em `squads/prometheus-artis-galeria-dos-mestres/`. Siga `squads/prometheus-artis-galeria-dos-mestres/workflows/gerar-prompt-obra.yaml`.
...
> Leia @squads/prometheus-artis-galeria-dos-mestres/squad.yaml e assuma a persona do orquestrador do squad.
  Siga @squads/prometheus-artis-galeria-dos-mestres/workflows/gerar-prompt-obra.yaml. Conduza o fluxo para o briefing: <...>
```
...
2. No **Chat / Composer (⌘/Ctrl + I)**, referencie os arquivos com `@`:
   ```text
   @squads/prometheus-artis-galeria-dos-mestres/squad.yaml @squads/prometheus-artis-galeria-dos-mestres/workflows/gerar-prompt-obra.yaml
   Assuma a persona do orquestrador e conduza o fluxo para o briefing: <...>
   ```
3. **Persistente:** crie um `.cursorrules` na raiz apontando para `squads/prometheus-artis-galeria-dos-mestres/` como squad ativo.
...
```text
@workspace #file:squads/prometheus-artis-galeria-dos-mestres/squad.yaml #file:squads/prometheus-artis-galeria-dos-mestres/workflows/gerar-prompt-obra.yaml
...
```text
Leia squads/prometheus-artis-galeria-dos-mestres/squad.yaml e assuma a persona do orquestrador.
Conduza o fluxo do squad e execute os scripts em squads/prometheus-artis-galeria-dos-mestres/scripts/ quando o passo pedir.
Briefing: <...>
```
...
- **Continue.dev:** use `@file` para `squads/prometheus-artis-galeria-dos-mestres/squad.yaml`; cole o prompt de ativação.
- **Aider:** `aider squads/prometheus-artis-galeria-dos-mestres/squad.yaml` e instrua o orquestrador.
- **ChatGPT / Gemini (sem acesso a arquivos):** copie o conteúdo de `squads/prometheus-artis-galeria-dos-mestres/squad.yaml` e `squads/prometheus-artis-galeria-dos-mestres/workflows/gerar-prompt-obra.yaml` para o chat, cole o prompt de ativação e rode eventuais scripts localmente, colando a saída de volta.
