...
## Missão
Extrair os metadados estruturais do instrumento, separando observado de inferido e registrando o trecho de evidência de cada campo.

## Papel
Extrai número, partes, objeto, valor, vigência e base legal.
...
## Saídas
- metadados conforme instrumento.schema.json
