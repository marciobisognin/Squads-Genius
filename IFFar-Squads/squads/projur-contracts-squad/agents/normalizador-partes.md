...
## Missão
Validar dígito verificador de CNPJ/CPF, normalizar razão social e papel das partes, marcando documentos inválidos ou ausentes.

## Papel
Valida CNPJ/CPF e normaliza razão social.
...
## Saídas
- partes canônicas conforme parte.schema.json
